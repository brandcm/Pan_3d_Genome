#!/bin/bash
#$ -N generate_pts_fastas
#$ -M colin.brand@ucsf.edu
#$ -m ae
#$ -cwd
#$ -o /wynton/group/capra/projects/pan_3d_genome/scripts/1_generate_FASTAs/generate_pts_fastas.out
#$ -e /wynton/group/capra/projects/pan_3d_genome/scripts/1_generate_FASTAs/generate_pts_fastas.err
#$ -l h_rt=36:00:00
#$ -l scratch=30G
...
samples=('Andromeda' 'Athanga' 'Bihati' 'Bwamble' 'Cindy-schwein' 'Cleo' 'Coco-chimp' 'Frederike' 'Harriet' 'Ikuru' 'Kidongo' 'Maya' 'Mgbadolite' 'Nakuu' 'Padda' 'Tongo' 'Trixie' 'Vincent' 'Washu' )
