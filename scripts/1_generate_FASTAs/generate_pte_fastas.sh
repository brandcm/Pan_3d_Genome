#!/bin/bash
#$ -N generate_pte_fastas
#$ -M colin.brand@ucsf.edu
#$ -m ae
#$ -cwd
#$ -o /wynton/group/capra/projects/pan_3d_genome/scripts/1_generate_FASTAs/generate_pte_fastas.out
#$ -e /wynton/group/capra/projects/pan_3d_genome/scripts/1_generate_FASTAs/generate_pte_fastas.err
#$ -l h_rt=36:00:00
#$ -l scratch=30G
...
samples=('Akwaya-Jean' 'Banyo' 'Basho' 'Damian' 'Julie-LWC21' 'Kopongo' 'Koto' 'Paquita' 'Taweh' 'Tobi' )
