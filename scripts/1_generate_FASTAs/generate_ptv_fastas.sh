#!/bin/bash
#$ -N generate_ptv_fastas
#$ -M colin.brand@ucsf.edu
#$ -m ae
#$ -cwd
#$ -o /wynton/group/capra/projects/pan_3d_genome/scripts/1_generate_FASTAs/generate_ptv_fastas.out
#$ -e /wynton/group/capra/projects/pan_3d_genome/scripts/1_generate_FASTAs/generate_ptv_fastas.err
#$ -l h_rt=36:00:00
#$ -l scratch=30G
...
samples=('Alice' 'Annie' 'Berta' 'Bosco' 'Cindy-verus' 'Clint' 'Jimmie' 'Koby' 'Linda' 'Mike' 'SeppToni' )
