#!/bin/bash
#$ -N generate_ptt_fastas
#$ -M colin.brand@ucsf.edu
#$ -m ae
#$ -cwd
#$ -o /wynton/group/capra/projects/pan_3d_genome/scripts/1_generate_FASTAs/generate_ptt_fastas.out
#$ -e /wynton/group/capra/projects/pan_3d_genome/scripts/1_generate_FASTAs/generate_ptt_fastas.err
#$ -l h_rt=36:00:00
#$ -l scratch=30G
...
samples=('Alfred' 'Blanquita' 'Brigitta' 'Cindy-troglodytes' 'Clara' 'Doris' 'Gamin' 'Julie-A959' 'Lara' 'Luky' 'Marlin' 'Mirinda' 'Negrita' 'Noemie' 'Tibe' 'Ula' 'Vaillant' 'Yogui' )
