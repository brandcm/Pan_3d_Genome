...
def main():
	...
	for cell_type in args.cell_types:
		...
		output_files[cell_type] = open(f'{args.output_directory}/3d_predictions_{cell_type}_{target_chromosome}.txt', 'w')

	# generate predictions per cell type per window in chromosome
