...
awk 'NR==FNR{A[$1]=$2; next} NF==2{$2=A[$2]; print ">" $2; next} 1' FS='\t' ../../data/rename_ancestral_GRCh38_seqs.txt FS='>' homo_sapiens_ancestor_GRCh38.fa | tail -n +2 > rehead_homo_sapiens_ancestor_GRCh38.fa
mv rehead_homo_sapiens_ancestor_GRCh38.fa homo_sapiens_ancestor_GRCh38.fa
bgzip -i homo_sapiens_ancestor_GRCh38.fa
mv homo_sapiens_ancestor_GRCh38.fa.gz ../../data && mv homo_sapiens_ancestor_GRCh38.fa.gz.gzi ../../data
